...
class Chef_menage(Personne):
    owner = models.ForeignKey(settings.AUTH_USER_MODEL, related_name='list_chef_menage', on_delete=models.CASCADE,null=True)
...
class Conjoint(Personne):
    ...
    owner1 = models.ForeignKey(settings.AUTH_USER_MODEL, related_name='list_conjoint', on_delete=models.CASCADE,null=True)
    def __str__(self):
        return '{}_{}'.format(self.nom,self.prenom)
...
class Charge(Personne):
    parentg=models.ForeignKey(Chef_menage,on_delete=models.CASCADE)
    owner9 = models.ForeignKey(settings.AUTH_USER_MODEL, related_name='list_charge', on_delete=models.CASCADE,null=True)
    niveau_etude=models.CharField(max_length=100,blank=True,default='master')
    occupation=models.CharField(max_length=100,blank=True,default='Informaticien')
    def __str__(self):
        return '{}_{}'.format(self.nom,self.prenom)
...
class Migrant(models.Model):
    ...
    owner7 = models.ForeignKey(settings.AUTH_USER_MODEL, related_name='list_migrant', on_delete=models.CASCADE,null=True)
...
class Deces(models.Model):
    ...
    owner8 = models.ForeignKey(settings.AUTH_USER_MODEL, related_name='list_deces', on_delete=models.CASCADE,null=True)
...
class Emigration(models.Model):
    parentd=models.ForeignKey(Chef_menage,on_delete=models.CASCADE)
    owner2 = models.ForeignKey(settings.AUTH_USER_MODEL, related_name='list_emigration', on_delete=models.CASCADE,null=True)
    sexed=(('M','Maxculin'),('F','Feminin'))
    sexesd=models.CharField(max_length=1,choices=sexed)
